...
Namespace DatasetOtisTableAdapters
    ...
    Partial Public Class RespuestasTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT Respuesta from Respuestas" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "where IdPregunta = @IdPregunta"
        ...
        Public Overridable Overloads Function FillBy(ByVal dataTable As DatasetOtis.RespuestasDataTable, ByVal IdPregunta As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (IdPregunta.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(IdPregunta.Value, Integer)
            Else
        ...
        Public Overridable Overloads Function GetDataBy(ByVal IdPregunta As Global.System.Nullable(Of Integer)) As DatasetOtis.RespuestasDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (IdPregunta.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(IdPregunta.Value, Integer)
            Else
